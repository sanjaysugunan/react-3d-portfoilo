...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      flex flew-row items-start gap-5
      `}>
          ...
          <div>
            ...
            text-white
            `}>Hi, I'm <span className="text-[#915eff]">Sanjay</span></h1>
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              I develop Full-Stack MERN web applications.<br className="sm:block hidden"/>
              Currently a physics undergrad.
            </p>
          </div>
      </div>
      <ComputersCanvas />
